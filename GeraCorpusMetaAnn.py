...
class GeraCorpus(object):
  ...
  def gera_xml_documento(self, corpo_noticia, contador_noticia, id_noticia):
    ...
    documento.append(etree.Element('info', type='banco_id', value=str(id_noticia)))
  ...
  def gera_xml_segmentacao(self, dicionario_segmentos, contador_noticia, matriz_similaridade):
    ...
    for id_segmento in dicionario_segmentos:
      ...
      xml_segmento = etree.Element('unit', id='{0:0{1}d}'.format(id_segmento - self.desconto_segmento,4))
  ...
  def gera_noticias(self):
    ...
    for (corpo_noticia, id_noticia) in cursor_noticias:
      ...
      #Para cada segmento, adiciona na lista para calculo de tf-idf e adiciona nos segmentos da noticia
    ...
    for id_noticia in id_noticias:
      ...
      arquivo_noticia.write(self.gera_xml_documento(dicionario_noticias[id_noticia][-1],i,id_noticia))
      ...
      arquivo_segmentacao.write(self.gera_xml_segmentacao(dicionario_noticias[id_noticia],i, matriz_similaridade))
